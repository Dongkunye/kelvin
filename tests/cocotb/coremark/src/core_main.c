...
#error "Please define a way to initialize a memory block."
    ...
    *(volatile ee_u32*)(TOHOST_ADDR) = total_time;
    *(volatile ee_u32*)(TOHOST_ADDR+4) = total_errors;
    *(volatile ee_u32*)(TOHOST_ADDR+8) = 8;
	...
	//*(volatile int*)(TOHOST_ADDR) = total_time;
	//*(volatile int*)(TOHOST_ADDR+4) = total_errors;
	//*(volatile int*)(TOHOST_ADDR+8) = 0x8;
#if HAS_FLOAT
